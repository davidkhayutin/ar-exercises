...
# Your code goes here ...
p Employee.create(first_name: "Khurram", last_name: "Virani", hourly_rate: 80)
...
@store2.employees.create(first_name: "Kevin", last_name: "Lastname", hourly_rate: 40)
@store2.employees.create(first_name: "Miche", last_name: "Hayes", hourly_rate: 40)
